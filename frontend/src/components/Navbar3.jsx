    ...
    return(
      <Nav className="justify-content-center" activeKey="#home" id="home" >
        ...
        <Navbar.Collapse id="basic-navbar-nav" className="text-center" style={{marginLeft:"250px"}} >
          ...
          <Nav.Item>
            <Nav.Link><Link to="/features">Calendar</Link></Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link><Link to="/pricing">Board</Link></Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link><Link to="/contact">Productivity</Link></Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link><Link to="/contact">Chat</Link></Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link><Link to="/contact">Discover</Link></Nav.Link>
          </Nav.Item>
          </Nav>
        </Navbar.Collapse>
      </Navbar>
